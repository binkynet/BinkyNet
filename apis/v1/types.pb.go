...
type LocalWorkerInfo struct {
	...
	LocalWorkerServicePort int32 `protobuf:"varint,12,opt,name=local_worker_service_port,json=localWorkerServicePort,proto3" json:"local_worker_service_port,omitempty"`
	// If set, LocalWorkerService is served over TLS.
	LocalWorkerServiceSecure bool `protobuf:"varint,13,opt,name=local_worker_service_secure,json=localWorkerServiceSecure,proto3" json:"local_worker_service_secure,omitempty"`
	// SSH port (if any)
	SshPort int32 `protobuf:"varint,14,opt,name=ssh_port,json=sshPort,proto3" json:"ssh_port,omitempty"`
	...
	SupportsSetLocRequest bool `protobuf:"varint,102,opt,name=supports_set_loc_request,json=supportsSetLocRequest,proto3" json:"supports_set_loc_request,omitempty"`
	// If set, local worker implements LocalWorkerService.SetPowerRequest
	SupportsSetPowerRequest bool `protobuf:"varint,103,opt,name=supports_set_power_request,json=supportsSetPowerRequest,proto3" json:"supports_set_power_request,omitempty"`
	// If set, local worker implements LocalWorkerService.SetOutputRequest
	SupportsSetOutputRequest bool `protobuf:"varint,104,opt,name=supports_set_output_request,json=supportsSetOutputRequest,proto3" json:"supports_set_output_request,omitempty"`
	// If set, local worker implements LocalWorkerService.SetSwitchRequest
	SupportsSetSwitchRequest bool `protobuf:"varint,105,opt,name=supports_set_switch_request,json=supportsSetSwitchRequest,proto3" json:"supports_set_switch_request,omitempty"`
	// If set, local worker implements LocalWorkerService.SetDeviceDiscoveryRequest
	SupportsSetDeviceDiscoveryRequest bool `protobuf:"varint,106,opt,name=supports_set_device_discovery_request,json=supportsSetDeviceDiscoveryRequest,proto3" json:"supports_set_device_discovery_request,omitempty"`
	// Information about all routers that are currently online
	OnlineRouters []*RouterInfo `protobuf:"bytes,201,rep,name=online_routers,json=onlineRouters,proto3" json:"online_routers,omitempty"`
	// Information about all routers that are currently offline
	OfflineRouters       []*RouterInfo `protobuf:"bytes,202,rep,name=offline_routers,json=offlineRouters,proto3" json:"offline_routers,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
func (m *LocalWorkerInfo) GetLocalWorkerServicePort() int32 {
	if m != nil {
		return m.LocalWorkerServicePort
	}
	return 0
}
...
func (m *LocalWorkerInfo) GetLocalWorkerServiceSecure() bool {
	if m != nil {
		return m.LocalWorkerServiceSecure
	}
	return false
}

func (m *LocalWorkerInfo) GetSshPort() int32 {
	if m != nil {
		return m.SshPort
	}
	return 0
...
func (m *LocalWorkerInfo) GetSupportsSetLocRequest() bool {
	if m != nil {
		return m.SupportsSetLocRequest
	}
	return false
}
...
func (m *LocalWorkerInfo) GetSupportsSetPowerRequest() bool {
	if m != nil {
		return m.SupportsSetPowerRequest
	}
	return false
}
...
func (m *LocalWorkerInfo) GetSupportsSetOutputRequest() bool {
	if m != nil {
		return m.SupportsSetOutputRequest
	}
	return false
}
...
func (m *LocalWorkerInfo) GetSupportsSetSwitchRequest() bool {
	if m != nil {
		return m.SupportsSetSwitchRequest
	}
	return false
}
...
func (m *LocalWorkerInfo) GetSupportsSetDeviceDiscoveryRequest() bool {
	if m != nil {
		return m.SupportsSetDeviceDiscoveryRequest
	}
	return false
}

func (m *LocalWorkerInfo) GetOnlineRouters() []*RouterInfo {
	if m != nil {
		return m.OnlineRouters
	}
	return nil
}

func (m *LocalWorkerInfo) GetOfflineRouters() []*RouterInfo {
	if m != nil {
		return m.OfflineRouters
	}
	return nil
}
...
type RouterInfo struct {
	...
	Description string `protobuf:"bytes,2,opt,name=description,proto3" json:"description,omitempty"`
	// Version of the router in semantic versioning format.
	// E.g. 1.0.4
	Version string `protobuf:"bytes,3,opt,name=version,proto3" json:"version,omitempty"`
	...
	// HTTP(s) port to serve metrics on (if any)
	MetricsPort int32 `protobuf:"varint,10,opt,name=metrics_port,json=metricsPort,proto3" json:"metrics_port,omitempty"`
	// If set to true, metrics are served over HTTPS, otherwise HTTP
	MetricsSecure bool `protobuf:"varint,11,opt,name=metrics_secure,json=metricsSecure,proto3" json:"metrics_secure,omitempty"`
	// If set, router implements LocalWorkerService.Reset
	SupportsReset        bool     `protobuf:"varint,101,opt,name=supports_reset,json=supportsReset,proto3" json:"supports_reset,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *RouterInfo) GetModuleId() string {
	if m != nil {
		return m.ModuleId
	}
	return ""
...
func (m *RouterInfo) GetDescription() string {
	if m != nil {
		return m.Description
	}
	return ""
...
func (m *RouterInfo) GetVersion() string {
	if m != nil {
		return m.Version
	}
	return ""
...
func (m *RouterInfo) GetUptime() int64 {
	if m != nil {
		return m.Uptime
	}
	return 0
...
func (m *RouterInfo) GetIpAddress() string {
	if m != nil {
		return m.IpAddress
	}
	return ""
...
func (m *RouterInfo) GetMetricsPort() int32 {
	if m != nil {
		return m.MetricsPort
	}
	return 0
...
func (m *RouterInfo) GetMetricsSecure() bool {
	if m != nil {
		return m.MetricsSecure
	}
	return false
...
func (m *RouterInfo) GetSupportsReset() bool {
	if m != nil {
		return m.SupportsReset
	}
	return false
...
type Object struct {
	...
	Configuration        map[ObjectConfigKey]string `protobuf:"bytes,4,rep,name=configuration,proto3,castkey=ObjectConfigKey" json:"configuration,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
	XXX_NoUnkeyedLiteral struct{}                   `json:"-"`
	XXX_unrecognized     []byte                     `json:"-"`
	XXX_sizecache        int32                      `json:"-"`
}
...
func init() {
	...
	proto.RegisterType((*RouterInfo)(nil), "binkynet.v1.RouterInfo")
	...
	proto.RegisterMapType((map[ObjectConfigKey]string)(nil), "binkynet.v1.Object.ConfigurationEntry")
...
var fileDescriptor_d938547f84707355 = []byte{
	...
	,
}
...
func (m *LocalWorkerInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.OfflineRouters) > 0 {
		for iNdEx := len(m.OfflineRouters) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.OfflineRouters[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if len(m.OnlineRouters) > 0 {
		for iNdEx := len(m.OnlineRouters) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.OnlineRouters[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if m.SupportsSetDeviceDiscoveryRequest {
		i--
		if m.SupportsSetDeviceDiscoveryRequest {
			dAtA[i] = 1
		} else {
	...
	if m.LocalWorkerServicePort != 0 {
		i = encodeVarintTypes(dAtA, i, uint64(m.LocalWorkerServicePort))
		i--
		dAtA[i] = 0x60
	}
	if m.MetricsSecure {
...
func (m *RouterInfo) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *RouterInfo) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *RouterInfo) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *LocalWorkerInfo) Size() (n int) {
	...
	if m.LocalWorkerServicePort != 0 {
		n += 1 + sovTypes(uint64(m.LocalWorkerServicePort))
	}
	if m.LocalWorkerServiceSecure {
		n += 2
	}
	...
	if len(m.OnlineRouters) > 0 {
		for _, e := range m.OnlineRouters {
			l = e.Size()
			n += 2 + l + sovTypes(uint64(l))
		}
	}
	if len(m.OfflineRouters) > 0 {
		for _, e := range m.OfflineRouters {
			l = e.Size()
			n += 2 + l + sovTypes(uint64(l))
		}
	}
...
func (m *LocalWorkerInfo) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 12:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LocalWorkerServicePort", wireType)
			}
			m.LocalWorkerServicePort = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
					return ErrIntOverflowTypes
				}
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.LocalWorkerServicePort |= int32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 13:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field LocalWorkerServiceSecure", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.LocalWorkerServiceSecure = bool(v != 0)
		case 14:
			if wireType != 0 {
		...
		case 101:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SupportsReset", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SupportsReset = bool(v != 0)
		case 102:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SupportsSetLocRequest", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SupportsSetLocRequest = bool(v != 0)
		case 103:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SupportsSetPowerRequest", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SupportsSetPowerRequest = bool(v != 0)
		case 104:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SupportsSetOutputRequest", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SupportsSetOutputRequest = bool(v != 0)
		case 105:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SupportsSetSwitchRequest", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SupportsSetSwitchRequest = bool(v != 0)
		case 106:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field SupportsSetDeviceDiscoveryRequest", wireType)
			}
			var v int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.SupportsSetDeviceDiscoveryRequest = bool(v != 0)
		case 201:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OnlineRouters", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OnlineRouters = append(m.OnlineRouters, &RouterInfo{})
			if err := m.OnlineRouters[len(m.OnlineRouters)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 202:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field OfflineRouters", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.OfflineRouters = append(m.OfflineRouters, &RouterInfo{})
			if err := m.OfflineRouters[len(m.OfflineRouters)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		default:
...
func (m *RouterInfo) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
	...
	for iNdEx < l {
		...
		case 4:
			...
			if m.Configuration == nil {
				m.Configuration = make(map[ObjectConfigKey]string)
			}
			var mapkey ObjectConfigKey
			var mapvalue string
			for iNdEx < postIndex {
				entryPreIndex := iNdEx
				var wire uint64
				...
				if fieldNum == 1 {
					...
					mapkey = ObjectConfigKey(dAtA[iNdEx:postStringIndexmapkey])
			...
			m.Configuration[ObjectConfigKey(mapkey)] = mapvalue
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipTypes(dAtA[iNdEx:])
