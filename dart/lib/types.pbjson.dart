...
const LocalWorkerInfo$json = const {
  ...
  '2': const [
    ...
    const {'1': 'local_worker_service_port', '3': 12, '4': 1, '5': 5, '10': 'localWorkerServicePort'},
    const {'1': 'local_worker_service_secure', '3': 13, '4': 1, '5': 8, '10': 'localWorkerServiceSecure'},
    const {'1': 'supports_reset', '3': 101, '4': 1, '5': 8, '10': 'supportsReset'},
    const {'1': 'supports_set_loc_request', '3': 102, '4': 1, '5': 8, '10': 'supportsSetLocRequest'},
    const {'1': 'supports_set_power_request', '3': 103, '4': 1, '5': 8, '10': 'supportsSetPowerRequest'},
...
final $typed_data.Uint8List localWorkerInfoDescriptor = $convert.base64Decode('');
